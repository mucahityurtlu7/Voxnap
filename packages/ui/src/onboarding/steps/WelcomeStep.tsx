...
export function WelcomeStep() {
  return (
    <div className="flex flex-col gap-6">
      <div className="grid gap-3 sm:grid-cols-1">
        {HIGHLIGHTS.map((h) => {
          ...
          return (
            ...
            >
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-brand-gradient-soft text-brand-600 dark:text-brand-300">
      ...
      <p className="rounded-xl border border-border bg-surface-2 p-3 text-xs leading-relaxed text-text-subtle">
